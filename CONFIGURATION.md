...
| `FILESYSTEM_CONTEXT_CONCURRENCY`    | Auto (cores, min 4, cap 32) | 1-100  | Parallel file operations (further capped by `UV_THREADPOOL_SIZE`)                                                                                 | SSDs, many CPU cores          | HDDs, shared systems    |
